...
namespace kern.services.FroniusSolarWebClient.Model
{
    ...
    public partial class UserAddress : IEquatable<UserAddress>, IValidatableObject
    {
        ...
        public UserAddress(string street = default(string), string zipCode = default(string), string city = default(string), string state = default(string), string country = default(string))
        {
            this.Street = street;

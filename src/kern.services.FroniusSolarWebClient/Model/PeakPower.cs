...
namespace kern.services.FroniusSolarWebClient.Model
{
    ...
    /// PeakPower
    /// </summary>
    [DataContract(Name = "PeakPower")]
    public partial class PeakPower : IEquatable<PeakPower>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PeakPower" /> class.
        /// </summary>
        /// <param name="dc1">dc1.</param>
        /// <param name="dc2">dc2.</param>
        /// <param name="dc3">dc3.</param>
        /// <param name="dc4">dc4.</param>
        public PeakPower(double? dc1 = default(double?), double? dc2 = default(double?), double? dc3 = default(double?), double? dc4 = default(double?))
        {
            this.Dc1 = dc1;
            this.Dc2 = dc2;
            this.Dc3 = dc3;
        ...
        {
            return this.Equals(input as PeakPower);
        }

        /// <summary>
        /// Returns true if PeakPower instances are equal
        /// </summary>
        /// <param name="input">Instance of PeakPower to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PeakPower input)
        {
            if (input == null)
            {
                return false;

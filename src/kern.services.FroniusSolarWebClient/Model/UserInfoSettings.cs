...
namespace kern.services.FroniusSolarWebClient.Model
{
    ...
    /// UserInfoSettings
    /// </summary>
    [DataContract(Name = "UserInfo_settings")]
    public partial class UserInfoSettings : IEquatable<UserInfoSettings>, IValidatableObject
    {
        /// <summary>
        ...
        public UserInfoSettings(string timeZone = default(string), string dateFormat = default(string), string timeFormat = default(string), string language = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserInfoSettings {\n");
        ...
        {
            return this.Equals(input as UserInfoSettings);
        }

        /// <summary>
        /// Returns true if UserInfoSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of UserInfoSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserInfoSettings input)
        {
            if (input == null)
            {
                return false;

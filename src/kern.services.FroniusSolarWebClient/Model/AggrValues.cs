...
namespace kern.services.FroniusSolarWebClient.Model
{
    ...
    /// AggrValues
    /// </summary>
    [DataContract(Name = "AggrValues")]
    public partial class AggrValues : IEquatable<AggrValues>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AggrValues" /> class.
        /// </summary>
        /// <param name="pvSystemId">pvSystemId.</param>
        /// <param name="deviceId">deviceId.</param>
        /// <param name="data">data.</param>
        /// <param name="links">links.</param>
        public AggrValues(string pvSystemId = default(string), string deviceId = default(string), List<AggrData> data = default(List<AggrData>), AggregatedValuesLinks links = default(AggregatedValuesLinks))
        {
        ...
        public List<AggrData> Data { get; set; }
        ...
        {
            return this.Equals(input as AggrValues);
        }

        /// <summary>
        /// Returns true if AggrValues instances are equal
        /// </summary>
        /// <param name="input">Instance of AggrValues to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AggrValues input)
        {
            if (input == null)
            {
                return false;

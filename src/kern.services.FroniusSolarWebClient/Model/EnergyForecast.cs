...
namespace kern.services.FroniusSolarWebClient.Model
{
    ...
    /// EnergyForecast
    /// </summary>
    [DataContract(Name = "EnergyForecast")]
    public partial class EnergyForecast : IEquatable<EnergyForecast>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyForecast" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pvSystemId">pvSystemId.</param>
        public EnergyForecast(List<WeatherRecord> data = default(List<WeatherRecord>), string pvSystemId = default(string))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnergyForecast {\n");
        ...
        {
            return this.Equals(input as EnergyForecast);
        }

        /// <summary>
        /// Returns true if EnergyForecast instances are equal
        /// </summary>
        /// <param name="input">Instance of EnergyForecast to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnergyForecast input)
        {
            if (input == null)
            {
                return false;

...
namespace kern.services.FroniusSolarWebClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.solarweb.com/swqapi";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.solarweb.com/swqapi"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.solarweb.com/swqapi") : this()
        {
        ...
        {
            string report = "C# SDK (kern.services.FroniusSolarWebClient) Debug Report:\n";
